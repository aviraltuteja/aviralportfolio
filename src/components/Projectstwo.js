...
import filmone from "../film1.png";
import filmtwo from "../film2.png";
import filmthree from "../film3.png";
import musicone from "../music1.png";
import musictwo from "../music2.png";
...
const Projectstwo = () => {
  ...
  const CodingData = [
    ...
    },
    {
      ...
      link: "www.google.com",
      batch: "Coding",
      skills: ["React Basics", "Advanced CSS", "React Hooks", "Asset Handling"],
    },
  ];
  const MusicData = [
    {
      ...
      link: "www.google.com",
      batch: "Music",
      skills: ["Networking", "Frugal Resource Expenditure", "Marketing"],
    },
    {
    ...
    <div className="twomain">
      <div className="tabbar">
        <div
          ...
          className={value === 1 ? "tabheaddiv activetab" : "tabheaddiv"}
        >
          <h4 className="tabhead">Coding</h4>
        </div>
        <div
          onClick={() => {
            setValue(2);
          }}
          className={value === 2 ? "tabheaddiv activetab" : "tabheaddiv"}
        >
          <h4 className="tabhead">Filmmaking</h4>
        </div>
        <div
          onClick={() => {
            setValue(3);
          }}
          className={value === 3 ? "tabheaddiv activetab" : "tabheaddiv"}
        >
          <h4 className="tabhead">Music</h4>
        </div>
      </div>
      <div className="tabcontent">
        <div
          className={value === 1 ? "seccontent seccontenttrue" : "seccontent"}
        >
        ...
        <div
          className={value === 2 ? "seccontent seccontenttrue" : "seccontent"}
        >
        ...
        <div
          className={value === 3 ? "seccontent seccontenttrue" : "seccontent"}
        >
